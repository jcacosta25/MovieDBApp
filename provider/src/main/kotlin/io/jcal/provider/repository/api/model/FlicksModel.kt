...
data class TvShowsDTO(
    @SerializedName(value = "dates") val dates: DatesDTO,
    @SerializedName("page") val page: Int,
    @SerializedName(value = "results") val results: List<TvShowDTO>,
    @SerializedName(value = "total_pages") val totalPages: Int,
    @SerializedName(value = "total_results") val totalResults: Int
)

data class DatesDTO(
    @SerializedName(value = "maximum") val maximum: String,
    @SerializedName(value = "minimum") val minimum: String
)

data class MoviesDTO(
    @SerializedName(value = "dates") val dates: DatesDTO,
    @SerializedName(value = "page") val page: Int,
    @SerializedName(value = "results") val results: List<MovieDTO>,
    @SerializedName(value = "total_pages") val totalPages: Int,
    @SerializedName(value = "total_results") val totalResults: Int
)
...
data class MovieDTO(
    ...
    @SerializedName(value = "belongs_to_collection") val belongsToCollection: Any,
    @SerializedName(value = "budget") val budget: Int,
    @SerializedName(value = "genres") val genres: List<GenreDTO>,
    ...
    @SerializedName(value = "production_companies") val productionCompanyModels: List<ProductionCompanyDTO>,
    @SerializedName(value = "production_countries") val productionCountryModels: List<ProductionCountryDTO>,
    @SerializedName(value = "release_date") val releaseDate: String,
    @SerializedName(value = "revenue") val revenue: Int,
    @SerializedName(value = "runtime") val runtime: Int,
    @SerializedName(value = "spoken_languages") val spokenLanguageModels: List<SpokenLanguageDTO>,
...
data class SpokenLanguageDTO(
    @SerializedName(value = "iso_639_1") val iso6391: String,
...
data class ProductionCompanyDTO(
    @SerializedName(value = "id") val id: Int,
    @SerializedName(value = "logo_path") val logoPath: String,
    @SerializedName(value = "name") val name: String,
    @SerializedName(value = "origin_country") val originCountry: String
)

data class ProductionCountryDTO(
    @SerializedName(value = "iso_3166_1") val iso31661: String,
    @SerializedName(value = "name") val name: String
)
...
data class TvShowDTO(
    ...
    @SerializedName(value = "episode_count") val episodeCount: Int,
    @SerializedName(value = "season_number") val seasonNumber: Int,
    @SerializedName(value = "backdrop_path") val backdropPath: String,
    @SerializedName(value = "created_by") val createdBy: List<CreatorDTO>,
    @SerializedName(value = "episode_run_time") val episodeRunTime: List<Int>,
    ...
    @SerializedName(value = "last_episode_to_air") val lastEpisodeToAir: EpisodeDTO?,
    @SerializedName(value = "name") val name: String,
    @SerializedName(value = "networks") val networks: List<TvNetworkDTO>,
    @SerializedName(value = "next_episode_to_air") val nextEpisodeToAir: EpisodeDTO?,
    ...
    @SerializedName(value = "popularity") val popularity: Double,
    @SerializedName(value = "poster_path") val posterPath: String,
    @SerializedName(value = "production_companies") val productionCompanies: List<ProductionCompanyDTO>,
    @SerializedName(value = "seasons") val seasons: List<SeasonDTO>?,
    @SerializedName(value = "status") val status: String,
...
data class SeasonDTO(
    ...
    @SerializedName(value = "poster_path") val posterPath: String,
    @SerializedName(value = "season_number") val seasonNumber: Int,
    @SerializedName(value = "episodes") val episodes: List<EpisodeDTO>?
)

data class EpisodeDTO(
    @SerializedName(value = "id") val id: Int,
    @SerializedName(value = "air_date") val airDate: String,
    @SerializedName(value = "episode_number") val episodeNumber: Int,
    @SerializedName(value = "name") val name: String,
    @SerializedName(value = "overview") val overview: String,
    @SerializedName(value = "production_code") val productionCode: String,
    @SerializedName(value = "season_number") val seasonNumber: Int,
    @SerializedName(value = "show_id") val showId: Int,
    @SerializedName(value = "still_path") val stillPath: Any,
    @SerializedName(value = "vote_average") val voteAverage: Int,
    @SerializedName(value = "vote_count") val voteCount: Int,
    @SerializedName(value = "crew") val crew: List<CrewDTO>,
    @SerializedName(value = "guest_stars") val guestStars: List<GuestStarDTO>
)
...
data class GuestStarDTO(
    ...
    @SerializedName(value = "credit_id") val creditId: String,
    @SerializedName(value = "name") val name: String,
    @SerializedName(value = "order") val order: Int,
    @SerializedName(value = "profile_path") val profilePath: String
)
...
data class PeopleDTO(
    @SerializedName(value = "id") val id: Int,
    @SerializedName(value = "adult") val adult: Boolean,
    @SerializedName(value = "also_known_as") val alsoKnownAs: List<String>,
    @SerializedName(value = "biography") val biography: String,
    @SerializedName(value = "birthday") val birthday: String,
    @SerializedName(value = "deathday") val deathday: Any,
    @SerializedName(value = "gender") val gender: Int,
    @SerializedName(value = "homepage") val homepage: Any,
    @SerializedName(value = "imdb_id") val imdbId: String,
    @SerializedName(value = "known_for_department") val knownForDepartment: String,
    @SerializedName(value = "name") val name: String,
